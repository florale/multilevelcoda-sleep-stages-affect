...
sleep_affect_sub_list <- lapply(list(
...
# graphs
sleep_affect_plot_b_supp <- readRDS(paste0(outputdir, "sleep_affect_plot_b_supp", ".RDS"))
sleep_affect_plot_w_supp <- readRDS(paste0(outputdir, "sleep_affect_plot_w_supp", ".RDS"))
rg <- readRDS(paste0(outputdir, "sleep_affect_rg", ".RDS"))
